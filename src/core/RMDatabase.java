...
public class RMDatabase {
	...
	public class AtomNameNotFoundException extends Exception {
	...
	public AdvNum queryAtom(String inAtom) throws AtomNameNotFoundException {// 查询某原子的摩尔质量
	...
	public AdvNum queryMolarMass(Formula inFormula) throws AtomNameNotFoundException {// 查询某化学式的摩尔质量
		AdvNum mass = new AdvNum();
		
		for (Map.Entry<String,Integer> entry : inFormula.mapAtomList.entrySet()) {
			mass.add(this.queryAtom(entry.getKey()).multiply(entry.getValue()));
		}
